...
function AdminMain(props) {
  ...
  useEffect(() => {
    fetch(
      `http://40.88.23.186:9090/api/admin/bookings/count/${new Date()
        .toISOString()
        .substr(0, 10)}`,
      {
        method: "GET",
  ...
  useEffect(() => {
    fetch(
      `http://40.88.23.186:9090/api/admin/employee-count/${new Date()
        .toISOString()
        .substr(0, 10)}/true`,
      {
        method: "GET",
    ...
    <div className="adminPage">
      ...
      <div className="parentempdata">
        ...
        <div className="fundata">
          <FCards
            img="https://pocproject.000webhostapp.com/images/QRScan.png"
            title="QR Scan"
            address="/qrcodescan"
            color={card1.color}
          />
          <FCards
            img="https://pocproject.000webhostapp.com/images/AddUser.png"
            title="ADD User"
            address="/adduser"
            color={card2.color}
            onclick={() => <AddUser />}
          />
          <FCards
            img="https://pocproject.000webhostapp.com/images/holidays.png"
            title="Holiday List"
            address="/holiday"
            color={card4.color}
          />
          <FCards
            img="https://pocproject.000webhostapp.com/images/shift.png"
            title="Add Shifts"
            address="/addshift"
            color={card4.color}
          />
